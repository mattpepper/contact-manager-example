...
define('data-client',["require", "exports", "aurelia-fetch-client"], function (require, exports, aurelia_fetch_client_1) {
    "use strict";
    var apiDataClient = (function () {
        function apiDataClient() {
        ...
        apiDataClient.prototype.fetch = function (url) {
...
define('web-api',["require", "exports", "./data-client"], function (require, exports, data_client_1) {
    "use strict";
    var latency = 200;
    var id = 0;
    function getId() {
        ...
        WebAPI.prototype.getContactList = function () {
            ...
            return new Promise(function (resolve) {
                setTimeout(function () {
                    ...
                    var results = _this.fetch('data/contacts.json')
                        .then(function (response) {
                        return response.json()
                            .then(function (json) {
                            var list = JSON.parse(JSON.stringify(json));
                            _this.contacts = list.map(function (x) {
                                return {
                                    id: getId(),
